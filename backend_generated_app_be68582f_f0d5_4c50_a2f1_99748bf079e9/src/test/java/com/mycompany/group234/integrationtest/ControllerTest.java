...
class ControllerTest {
  ...
  void  teardown() {
    ...
    jdbcTemplate.execute("DELETE FROM generated_app.GitHubCreds");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.FrontendAppFECapabilities");
     jdbcTemplate.execute("DELETE FROM generated_app.FETechnologySupported_Capabilities");
     ...
     jdbcTemplate.execute("DELETE FROM generated_app.FETechnologySupported_BETechnologies");
     jdbcTemplate.execute("DELETE FROM generated_app.BETechnologySupported_Databases");
     jdbcTemplate.execute("DELETE FROM generated_app.FETechnologyScreens");
