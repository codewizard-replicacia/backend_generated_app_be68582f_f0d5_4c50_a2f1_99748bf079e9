...
@Entity(name = "SiteMap")
@Table(name = "\"SiteMap\"", schema =  "\"generated_app\"")
@Data
...
public class SiteMap {
  ...
  @Column(name = "\"SiteMapId\"", nullable = true )
...
@JoinTable(
            name="\"SiteMapFlows\"",
            joinColumns = @JoinColumn( name="\"SiteMapId\""),
            inverseJoinColumns = @JoinColumn( name="\"ScreenFlowId\""), schema = "\"generated_app\"")
private List<ScreenFlow> flows = new ArrayList<>();
