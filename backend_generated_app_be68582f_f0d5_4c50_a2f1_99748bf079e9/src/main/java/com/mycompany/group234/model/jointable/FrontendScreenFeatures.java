...
@Entity(name = "FrontendScreenFeatures")
@Table(schema = "\"generated_app\"", name = "\"FrontendScreenFeatures\"")
@Data
public class FrontendScreenFeatures{
