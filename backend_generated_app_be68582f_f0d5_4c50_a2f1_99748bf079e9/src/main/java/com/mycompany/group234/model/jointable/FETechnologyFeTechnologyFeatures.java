...
@Entity(name = "FETechnologyFeTechnologyFeatures")
@Table(schema = "\"generated_app\"", name = "\"FETechnologyFeTechnologyFeatures\"")
@Data
public class FETechnologyFeTechnologyFeatures{
    ...
    private Integer feTechnologyFeatures;
}