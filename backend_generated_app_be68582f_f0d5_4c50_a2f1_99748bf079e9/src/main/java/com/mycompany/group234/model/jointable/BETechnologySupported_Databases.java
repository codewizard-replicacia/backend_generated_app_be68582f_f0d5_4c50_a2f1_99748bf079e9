...
@Entity(name = "BETechnologySupported_Databases")
@Table(schema = "\"generated_app\"", name = "\"BETechnologySupported_Databases\"")
@Data
public class BETechnologySupported_Databases{
