...
@Entity(name = "BETechnologyBeTechnologyFeatures")
@Table(schema = "\"generated_app\"", name = "\"BETechnologyBeTechnologyFeatures\"")
@Data
public class BETechnologyBeTechnologyFeatures{
    ...
    private Integer beTechnologyFeatures;
}