...
@Entity(name = "ScreenFeature")
@Table(name = "\"ScreenFeature\"", schema =  "\"generated_app\"")
@Data
...
public class ScreenFeature {
  ...
  @Column(name = "\"ScreenFeatureId\"", nullable = true )
  private Integer screenFeatureId;
	  
  @Column(name = "\"ScreenFeatureName\"", nullable = true )
  private String screenFeatureName;
  
	  
  @Column(name = "\"FeatureDescription\"", nullable = true )
  private String featureDescription;
  
	  
  @Column(name = "\"FeatureExplanation\"", nullable = true )
  ...
  + "ScreenFeatureId= " + screenFeatureId  + ", " 
  + "ScreenFeatureName= " + screenFeatureName  + ", " 
