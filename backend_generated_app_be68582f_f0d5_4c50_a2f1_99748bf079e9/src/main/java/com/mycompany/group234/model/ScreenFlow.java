...
@Entity(name = "ScreenFlow")
@Table(name = "\"ScreenFlow\"", schema =  "\"generated_app\"")
@Data
...
public class ScreenFlow {
  ...
  @Column(name = "\"ScreenFlowId\"", nullable = true )
...
@JoinTable(
            name="\"ScreenFlowFlow\"",
            joinColumns = @JoinColumn( name="\"ScreenFlowId\""),
            inverseJoinColumns = @JoinColumn( name="\"FeScreenId\""), schema = "\"generated_app\"")
private List<FrontendScreen> flow = new ArrayList<>();
