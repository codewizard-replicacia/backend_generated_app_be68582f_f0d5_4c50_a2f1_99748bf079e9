...
@Entity(name = "SettingsGitHubAccounts")
@Table(schema = "\"generated_app\"", name = "\"SettingsGitHubAccounts\"")
@Data
public class SettingsGitHubAccounts{
    ...
    @Column(name = "\"GitHubCredId\"")
    private Long gitHubCredId;
