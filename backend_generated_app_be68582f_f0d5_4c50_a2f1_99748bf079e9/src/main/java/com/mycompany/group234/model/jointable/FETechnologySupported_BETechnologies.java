...
@Entity(name = "FETechnologySupported_BETechnologies")
@Table(schema = "\"generated_app\"", name = "\"FETechnologySupported_BETechnologies\"")
@Data
public class FETechnologySupported_BETechnologies{
