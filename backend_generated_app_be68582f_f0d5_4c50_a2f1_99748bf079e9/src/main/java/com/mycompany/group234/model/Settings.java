...
@Table(name = "\"Settings\"", schema =  "\"generated_app\"")
@Data
...
public class Settings {
  ...
  @Column(name = "\"SettingsId\"", nullable = true )
...
@JoinTable(
            name="\"SettingsGitHubAccounts\"",
            joinColumns = @JoinColumn( name="\"SettingsId\""),
            inverseJoinColumns = @JoinColumn( name="\"GitHubCredId\""), schema = "\"generated_app\"")
private List<GitHubCreds> gitHubAccounts = new ArrayList<>();
