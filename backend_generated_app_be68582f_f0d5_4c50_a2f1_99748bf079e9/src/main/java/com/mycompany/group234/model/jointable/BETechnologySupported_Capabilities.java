...
@Entity(name = "BETechnologySupported_Capabilities")
@Table(schema = "\"generated_app\"", name = "\"BETechnologySupported_Capabilities\"")
@Data
public class BETechnologySupported_Capabilities{
